...
*/
  class BarChart extends React.Component {
    ...
    render() {
      ...
      var data = [
        { value: d['rprib1'] + d['rprib2'] + d['rprib3'] + d['rprib4'] + d['rprib5'] +d['rprib6'] + d['rprib7'] + d['rprib8'] + d['rprib9'] +d['rprib10'] + d['rprib11'] + d['rprib12'] },
        { value: d['rplrib1']+ d['rplrib2'] + d['rplrib3']+ d['rplrib4'] + d['rplrib5'] + d['rplrib6'] + d['rplrib7'] + d['rplrib8'] + d['rplrib9'] + d['rplrib10'] + d['rplrib11'] + d['rplrib12'] },
        { value: d['ralrib1'] + d['ralrib2'] + d['ralrib3'] + d['ralrib4'] + d['ralrib5'] + d['ralrib6'] + d['ralrib7']+ d['ralrib8'] + d['ralrib9'] + d['ralrib10'] + d['ralrib11'] +d['ralrib12'] },
        { value: d['rarib2'] + d['rarib3'] + d['rarib4'] + d['rarib5'] + d['rarib6'] +d['rarib7'] +d ['rarib8'] + d['rarib9'] + d['rarib10'] },
      ];
